...
This section is for end-user focused documentation.

## Purpose

Use this folder for guides that help users adopt and use the library, including:
- getting started and installation
- core usage walkthroughs

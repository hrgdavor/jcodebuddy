...
| [DEC-023](DEC-023.md) | **R1 — Field enums are append-only ordinal ledgers**                   | Proposed | 2026-09-20 |
...
| [DEC-024](DEC-024.md) | **Deep (nested) change tracking — pull over push**                     | Proposed | 2026-09-20 |
...
| [DEC-025](DEC-025.md) | **Field-enum compaction is a deliberate, acknowledged ordinal migration** | Proposed | 2026-09-20 |

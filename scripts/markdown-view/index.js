 ...
 * and a place to play. Read it together with `doc/webview-link-api.md` (the contract) and `README.md`
...
IDE; see <code>doc/webview-link-api.md</code> for the contract.</p>
</main>
</div>

...
public enum PersonUpdatableView_ {
    ...
    changes(TypeUtils.parameterizedType(hr.hrg.hipster.entity.core.EEnumSet.class, PersonUpdateForm_.class));

    private final Type propertyType;

    private PersonUpdatableView_(Type propertyType) {

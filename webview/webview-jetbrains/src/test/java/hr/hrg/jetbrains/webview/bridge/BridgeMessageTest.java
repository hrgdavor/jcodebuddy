...
public class BridgeMessageTest {
    ...
    /**
     * This is the payload F1 in the plan was written about: the first implementation pulled {@code line}
     * out with a regular expression, so a path containing this text would have opened line 99.
     */
    @Test
